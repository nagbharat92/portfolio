    ...
    <div className="flex w-full flex-col gap-6 lg:flex-row lg:items-stretch lg:gap-8">
      ...
      <FadeInUp i={index} className="flex min-w-0 flex-1">
        <div
          ...
          className="relative flex w-full flex-col rounded-2xl bg-(--lab-stage) px-6 py-10 sm:px-10 sm:py-14 lg:py-8"
        >
          ...
          <button
            ...
            className="absolute right-3 top-3 z-10 flex cursor-pointer items-center gap-1.5 rounded-lg px-2 py-1 text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
